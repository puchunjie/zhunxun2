<template>
    <view class="addinst-container">
		<image class="step" src="../../static/step1.png"></image>
        <div class="addinst-form">
			<div class="form-title">基本信息</div>
			<singleElection title="机构类型" v-model="form.shopType" ScEnumKey="shopTypeEnum"></singleElection>
            <div class="form-group">
                <div class="label"><span class="require">*</span>机构名称</div>
                <div class="value">
			...
			<div class="form-group">
			    <div class="label"><span class="require">*</span>机构地址</div>
			    <div class="value">
			        <input v-model="form.shopAddress" placeholder="请输入机构经营地址 或 地图选点" type="text">
			    </div>
			</div>
			<div class="form-group">
            ...
            <div class="form-div">
                <div class="form-group block">
                    <div class="label block"><span class="require">*</span>机构门头照片<span class="tip">(请上传机构招牌照片或外部店面照片)</span></div>
                    <div class="value">
                        <upload ref="upload" @onChange="topChange" :viewMode="viewMode"></upload>
                    </div>
                </div>
            </div>
            <div class="form-div">
                <div class="form-group block">
                    <div class="label block"><span class="require">*</span>机构内部照片<span class="tip">(请上传机构内部照片)</span></div>
                    <div class="value">
