<template>
    <view class="addinst-container">
		<image class="step" src="../../static/step3.png"></image>
        <div class="addinst-form">
			<div class="form-title">银行卡等资料</div>
            ...
            <div class="form-div">
                <div class="form-group block">
                    <div class="label block" style="text-align: left;"><span class="require">*</span>身份证人像面照片</div>
                    <div class="value">
            ...
            <div class="form-div">
                <div class="form-group block">
                    <div class="label block" style="text-align: left;"><span class="require">*</span>身份证国徽面照片</div>
                    <div class="value">
			...
			<div class="query-btn">
				<div class="btn" @click="submit" :data-type="1">保存</div>
			</div>
        </div>
